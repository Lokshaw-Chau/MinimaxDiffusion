...
parser.add_argument(
    ...
    type=str,
    default="random",
    help="selection type for images",
)
parser.add_argument(
    '--tag',
    type=str,
...
parser.add_argument(
    "--train-dir",
    type=str,
    default="/root/share/ImageNet/train/",
...
parser.add_argument(
    "--val-dir",
    type=str,
    default="/root/share/ImageNet/val/",
...
args.exp_name = f"{args.subset}_{args.stud_name}_ipc{args.ipc}"
if not os.path.exists(f"./results/{args.exp_name}"):
    os.makedirs(f"./results/{args.exp_name}")

if not os.path.exists(f"./results/{args.exp_name}/{args.tag}"):
    os.makedirs(f"./results/{args.exp_name}/{args.tag}")

args.log_path = f"./results/{args.exp_name}/{args.tag}"
